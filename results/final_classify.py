...
def main(args):
    ...
    try:
        df_totals = pd.read_csv(f'{args.consult_folder}/proc_res/Totals/Stats.csv', index_col=0)
    except Exception:
    ...
    consult_stats_percentages = pd.Series(consult_stats/frame_total).add_suffix('_Percentage')
